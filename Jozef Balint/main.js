/**
 * Created by Joseph on 24.2.2017.
 */
...
$(document).ready(function () {
   ...
   $('#btn-ok').on('click', function(){
       day = $("#chosenDay").val();
       month = $("#chosenMonth").val() - 1;
       if(month > Object.keys(nameday).length || month < 1){
           result.html("Bad month input!");
       }else if(day < 1 || day > Object.keys(nameday[month]).length){
           result.html("Bad day input!");
       }else {
           result.html(nameday[month][day]);
       }
